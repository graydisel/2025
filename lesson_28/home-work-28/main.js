...
const slider = new Slider(imagesLinks);
// slider.test();
...
//
// document.querySelector('#slider .controls .next').addEventListener('click', slider.toNextClick);
// document.querySelector('#slider .controls .prev').addEventListener('click', toPrevClick);
// document.querySelector('#slider .indicators').addEventListener('click', onIndicatorClick);
